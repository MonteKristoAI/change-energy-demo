        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold leading-tight mb-6">
              Twenty-five years of hydrogen and natural gas, distilled into one practice.
            </h2>
          </div>
          <div className="space-y-4" style={{ color: "var(--color-muted)" }}>
            <p>
              The founders spent careers inside the alternative fuels industry. We watched the same mistakes repeat, project after project, because firms staffed engagements with juniors and supervised them lightly.
            </p>
            <p>
              We started Change Energy to do the opposite. Small senior team. Real depth in hydrogen, CNG, and LNG. The same people on your project from the first scoping call to the day the dispenser flows fuel.
            </p>
            <p>
              An international installed base of more than 150 alternative fuel infrastructure systems sits behind every recommendation we make. That experience shows up in what we flag, what we de-risk, and what we refuse to engineer because we have seen it fail before.
            </p>
          </div>
        </div>
      </section>
